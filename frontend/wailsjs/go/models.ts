export namespace models {
	...
	export class WorkspaceShort {
	    id: string;
	    name: string;
	
	    static createFrom(source: any = {}) {
	        return new WorkspaceShort(source);
	    }
	...
	export class WorkspaceList {
	    ...
	    static createFrom(source: any = {}) {
	        return new WorkspaceList(source);
	    }
	
	    constructor(source: any = {}) {
	        if ('string' === typeof source) source = JSON.parse(source);
	        this.main = this.convertValues(source["main"], Workspace);
	        this.list = this.convertValues(source["list"], WorkspaceShort);
	    }
